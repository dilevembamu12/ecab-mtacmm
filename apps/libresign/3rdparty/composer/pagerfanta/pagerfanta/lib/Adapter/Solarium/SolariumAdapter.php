...
class SolariumAdapter implements AdapterInterface
{
    ...
    public function __construct(private readonly ClientInterface $client, private readonly Query $query)
    {
    }
    /**
     * @return int<0, max>
    ...
    private function modifyQuery() : void
    {
        ...
        $this->query->setStart($this->resultSetStart)->setRows($this->resultSetRows);
    }
