...
{
    public function __construct(private readonly string $defaultView, private readonly ViewFactoryInterface $viewFactory, private readonly RouteGeneratorFactoryInterface $routeGeneratorFactory)
    {
    }
    /**
