...
FDF;
     ...
     */
    public function __construct(array $data, ?string $suffix = null, ?string $prefix = null, ?string $directory = null, ?string $encoding = 'UTF-8')
    {
        if ($directory === null) {
    ...
    protected function xmlEncode(?string $value) : ?string
    {
        ...
        return \defined('ENT_XML1') ? \htmlspecialchars($value, \ENT_XML1, 'UTF-8') : \htmlspecialchars($value);
    }
}
