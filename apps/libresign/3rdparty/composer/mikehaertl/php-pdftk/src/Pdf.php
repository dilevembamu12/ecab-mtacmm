...
class Pdf
{
     ...
     * @return Pdf the pdf instance for method chaining
     */
    public function cat(int|string|array|null $start = null, int|string|null $end = null, ?string $handle = null, ?string $qualifier = null, ?string $rotation = null) : self
    {
        $this->getCommand()->setOperation('cat')->addPageRange(\is_null($start) ? "" : $start, $end, $handle, $qualifier, $rotation);
        return $this;
    }
    /**
     ...
     * @return Pdf the pdf instance for method chaining
     */
    public function shuffle(int|string|array $start, int|string|null $end = null, ?string $handle = null, ?string $qualifier = null, ?string $rotation = null) : self
    {
    ...
    public function attachFiles(array $files, ?string $toPage = null) : self
    {
        ...
        $this->getCommand()->setOperation('attach_files')->setOperationArgument($files, \true);
        return $this;
    }
    /**
     ...
     * @return Pdf the pdf instance for method chaining
     */
    public function fillForm(string|array $data, string $encoding = 'UTF-8', bool $dropXfa = \true, string $format = 'xfdf') : self
    {
        $this->constrainSingleFile();
        if (\is_array($data)) {
        ...
        $this->getCommand()->setOperation('fill_form')->setOperationArgument($data, \true);
        if ($dropXfa) {
            $this->dropXfa();
        }
        return $this;
    ...
    public function updateInfo(string|array|InfoFields|InfoFile $data, string $encoding = 'UTF-8') : self
    {
        ...
        $this->getCommand()->setOperation($encoding == 'UTF-8' ? 'update_info_utf8' : 'update_info')->setOperationArgument($data, \true);
        return $this;
    }
    /**
    ...
    {
        $this->constrainSingleFile();
        $this->getCommand()->setOperation('background')->setOperationArgument($file, \true);
        return $this;
    }
    /**
    ...
    {
        $this->getCommand()->setOperation('multibackground')->setOperationArgument($file, \true);
        return $this;
    }
    /**
    ...
    {
        $this->constrainSingleFile();
        $this->getCommand()->setOperation('stamp')->setOperationArgument($file, \true);
        return $this;
    }
    /**
    ...
    {
        $this->getCommand()->setOperation('multistamp')->setOperationArgument($file, \true);
        return $this;
    }
    /**
     ...
     */
    public function getData(bool $utf8 = \true) : InfoFields|bool
    {
        ...
        if ($this->{$property} === null) {
            ...
            if (!$command->execute()) {
                ...
                $this->{$property} = new InfoFields(\trim($command->getOutput()));
            }
        }
     ...
     * failure
     */
    public function getDataFields(bool $utf8 = \true) : DataFields|bool
    {
        ...
        if ($this->{$property} === null) {
            ...
            if (!$command->execute()) {
                ...
                $this->{$property} = new DataFields(\trim($command->getOutput()));
            }
        }
        return $this->{$property};
    }
     ...
     * @return Pdf the pdf instance for method chaining
     */
    public function compress($compress = \true) : self
    {
        $this->getCommand()->addOption($compress ? 'compress' : 'uncompress');
        return $this;
    }
    /**
    ...
    {
        $this->getCommand()->addOption('need_appearances');
        return $this;
    }
    /**
    ...
    {
        $this->getCommand()->addOption('drop_xfa');
        return $this;
    }
    /**
     * Drop XMP meta data
    ...
    {
        $this->getCommand()->addOption('owner_pw', $password, \true);
        return $this;
    }
    /**
    ...
    {
        $this->getCommand()->addOption('user_pw', $password, \true);
        return $this;
    }
    /**
    ...
    {
        $this->getCommand()->addOption('replacement_font', $path);
        return $this;
    }
    /**
