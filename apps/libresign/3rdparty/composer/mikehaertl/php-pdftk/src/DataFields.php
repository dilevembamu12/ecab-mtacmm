...
class DataFields extends ArrayObject
{
     ...
     */
    public function __construct(?string $input = null, int $flags = 0, string $iterator_class = "ArrayIterator")
    {
        $this->_string = $input ?: '';
    ...
    {
        return \in_array($key, array('FieldValue', 'FieldValueDefault')) && \array_key_exists($n + 1, $lines) && !\preg_match('/^Field(Value|ValueDefault|Justification):/', $lines[$n + 1]);
    }
}
